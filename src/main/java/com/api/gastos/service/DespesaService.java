...
public class DespesaService {
    ...
    @Transactional(readOnly = true)
    public Page<DespesaDTO> obterPorDataEmissao(LocalDateTime dataInicio, LocalDateTime dataFim, Pageable pageable) {
        return despesaRepository.findByDataEmissaoBetween(dataInicio, dataFim, pageable)
            .map(Despesa::toDto);
    }
